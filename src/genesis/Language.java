...
public class Language {
    ...
    public String generateModel(Entity entity, String projectName) throws IOException, Exception, Throwable{
    ...
    public void overWriteRoute(Entity[] entities,String filepath)throws IOException, Exception, Throwable{
    ...
    public void generateAngularModel(Entity entity,String projectFilePath) throws IOException, Exception, Throwable{
    ...
    public void generateAngularService(Entity entity,String projectFilePath,String url)throws IOException, Exception, Throwable{
    ...
    public void generateAngularComponent(Entity entity,String projetctFilePathl)throws IOException, Exception, Throwable{
